...
class RomImporter:
    def run(self):
        ...
        for src_rom_name in os.listdir(import_dir_path):
            if not ConsoleConfigs.rom_file_extension_match(src_rom_name):
                continue
            ...
            dst_rom_path = RomsXML.compute_rom_path(rom_info)
