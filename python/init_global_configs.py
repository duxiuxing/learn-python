...
class Init_Global_Configs:
    def __init__(self):
        ...
        RA_Configs.android_roms_directory = "/storage/emulated/0/arcade/cps2"
        RA_Configs.ipad_roms_directory = "~/Documents/RetroArch/arcade/cps2"
        RA_Configs.ps3_roms_directory = "/dev_hdd0/game/RETROARCH/USRDIR/arcade/cps2"
        ...
        WiiSS_Configs.settings_list = [
            ...
            # CPS2 的原生分辨率是 384x224，故使用 23=384x448
            'video_vres = "23"',
        ]
