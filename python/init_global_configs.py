...
class Init_Global_Configs:
    def __init__(self):
        ...
        RA_Configs.wii_roms_relative_directory = "arcade/fba/neogeo"
        ...
        # Wii_AppConfigs
        Wii_AppConfigs.default_short_description = "SNK Neo Geo Emulator"
        ...
        # WiiSS_Configs
        WiiSS_Configs.core_file_name = Path("Arcade NEO.dol")
        ...
        # WiiFlow_Configs
        WiiFlow_Configs.plugin_name = "NEOGEO"
