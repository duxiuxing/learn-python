...
class Init_Global_Configs:
    def __init__(self):
        ...
        RA_Configs.win_roms_relative_directory = Path("nintendo\\nes")
        RA_Configs.wii_roms_relative_directory = "nintendo/nes"
        RA_Configs.android_roms_directory = "/storage/emulated/0/nintendo/nes"
        RA_Configs.ipad_roms_directory = "~/Documents/RetroArch/nintendo/nes"
        RA_Configs.ps3_roms_directory = "/dev_hdd0/game/RETROARCH/USRDIR/nintendo/nes"
        RA_Configs.win_roms_directory = Path("X:\\nintendo\\nes")
        RA_Configs.xbox_roms_directory = Path("E:\\nintendo\\nes")

        # Wii_AppConfigs
        Wii_AppConfigs.default_short_description = "Nintendo Nestopia Emulator"

        # WiiRA_Configs
        WiiRA_Configs.core_file_name = Path("nestopia_libretro_wii.dol")
        WiiRA_Configs.core_info_file_name = Path("nestopia_libretro.info")
        WiiRA_Configs.core_name = "Nintendo - NES / Famicom (Nestopia)"
        ...
        # WiiSS_Configs
        WiiSS_Configs.core_file_name = Path("Nintendo Nestopia.dol")
        WiiSS_Configs.data_folder_name = "NTMOD"
        ...
        # 任天堂红白机的原生分辨率是 256x224，故使用 26=512x448
        WiiSS_Configs.settings_dict["video_vres"] = "26"

        # WiiFlow_Configs
        WiiFlow_Configs.plugin_name = "NES"
