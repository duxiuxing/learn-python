...
if __name__ == "__main__":
    ...
    plugin_ra_app_configs = Wii_AppConfigs(
        app_name="Nintendo - FCEUmm",
        app_folder_base_name="fc",
        rom=None,
    )
    plugin_ra_app_configs.long_description = (
        "- Emulator for Nintendo games based on RetroArch\n"
        "- Based on a the FCEUmm fork of the FCEU emulator\n"
        "- It is very fast and supports many mappers"
    )

    plugin_ss_app_configs = Wii_AppConfigs(
        app_name="RA-SS NES FCEUmm",
        app_folder_base_name="fc",
        rom=None,
    )
